...
create procedure usp_getVerPeliculas( in _idEstadoPelicula int )
  select * from Pelicula where idEstadoPelicula = _idEstadoPelicula;
...
create procedure usp_ValidaLogin( in _Dni char(8), in _Contraseña char(8) )
  select idEmpleado from Empleado where Dni = _Dni and Contraseña = _Contraseña and Eliminado = 0;
...
call usp_getCine(9)
call usp_getVerPeliculas()
call usp_getPelicula(1)


call usp_getIDEmpleados()
call usp_ValidaLogin('71526133','71526133')
